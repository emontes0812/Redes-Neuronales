...
namespace Libredneuronal.RedNeuronal
{
    ...
    public abstract class Network : INetwork
    {
        ...
        /// </param>
        protected virtual void OnBeginEpoch(int currentIteration, Ajusteentrenamiento trainingSet)
        {
        ...
        /// </param>
        protected virtual void OnBeginSample(int currentIteration, Entrenamiento currentSample)
        {
        ...
        /// </param>
        protected virtual void OnEndSample(int currentIteration, Entrenamiento currentSample)
        {
